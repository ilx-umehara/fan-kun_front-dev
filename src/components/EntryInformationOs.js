  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Box sx={{ borderBottom: 1, borderColor: 'divider', flexWrap: 'wrap' }}>
        <StyledTabs value={value} onChange={handleChange} aria-label="basic tabs example" TabIndicatorProps={{ style: { display: 'none' } }}>
          <Tab label="基本情報" {...a11yProps(0)} sx={{ maxWidth: 'initial', minWidth: 'initial', width: '16.66%' }}/>
          <Tab label="希望条件" {...a11yProps(1)} sx={{ maxWidth: 'initial', minWidth: 'initial', width: '16.66%' }}/>
          <Tab label="OAスキル" {...a11yProps(2)} sx={{ maxWidth: 'initial', minWidth: 'initial', width: '16.66%' }}/>
          <Tab label="経験職種" {...a11yProps(3)} sx={{ maxWidth: 'initial', minWidth: 'initial', width: '16.66%' }}/>
          <Tab label="資格" {...a11yProps(4)} sx={{ maxWidth: 'initial', minWidth: 'initial', width: '16.66%' }}/>
          <Tab label="職歴/最終学歴" {...a11yProps(5)} sx={{ maxWidth: 'initial', minWidth: 'initial', width: '16.66%' }}/>
          <Tab label="社内用" {...a11yProps(6)} sx={{ maxWidth: 'initial', minWidth: 'initial', width: '16.66%' }}/>
          <Tab label="緊急連絡先" {...a11yProps(7)} sx={{ maxWidth: 'initial', minWidth: 'initial', width: '16.66%' }}/>
          <Tab label="給与口座" {...a11yProps(8)} sx={{ maxWidth: 'initial', minWidth: 'initial', width: '16.66%' }}/>
          <Tab label="社保・雇用" {...a11yProps(9)} sx={{ maxWidth: 'initial', minWidth: 'initial', width: '16.66%' }}/>
          <Tab label="在留カード" {...a11yProps(10)} sx={{ maxWidth: 'initial', minWidth: 'initial', width: '16.66%' }}/>
        </StyledTabs>
      </Box>
...
export default EntryInformationOs;