function PersonCircleMan(){
  return (
    <svg version="1.1" id="person_circle_man" x="0px" y="0px" viewBox="0 0 64 64" style={{enableBackground: 'new 0 0 64 64'}}>
      <style type="text/css" dangerouslySetInnerHTML={{__html: "\n    .person_circle_man0{fill:#548AD1;stroke:#548AD1;stroke-miterlimit:10;} .person_circle_man1{fill:#548AD1;}\n  " }} />
      <path className="person_circle_man0" d="M24,24c-2.2,0-4-0.7-5.4-2.1c-1.4-1.4-2.1-3.2-2.1-5.4s0.7-4,2.1-5.4C20,9.7,21.8,9,24,9s4,0.7,5.4,2.1
      ...
      <path className="person_circle_man1" d="M24,3c11.6,0,21,9.4,21,21s-9.4,21-21,21S3,35.6,3,24S12.4,3,24,3 M24,0C10.7,0,0,10.7,0,24
